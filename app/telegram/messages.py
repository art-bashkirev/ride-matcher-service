...
❌ /cancelride \\- Отменить поиск попутчиков""",
    ...
    "test_quote": '_"Мы нужны им такими, какие мы есть\\. Так что будьте собой\\. Только лучше\\."_',
    ...
    "stats_tip": f"{EMOJIS['tip']} _Кэш помогает улучшить время отклика, сохраняя часто используемые данные\\._",
    # Schedule Command
